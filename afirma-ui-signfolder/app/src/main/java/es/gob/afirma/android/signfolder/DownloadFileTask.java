...
final class DownloadFileTask extends AsyncTask<Void, Void, DocumentData> implements SaveFileListener {
	 ...
	 */
	DownloadFileTask(final String documentId, final int type, final String proposedName, final String mimetype, final boolean extDir, final CommManager commManager, final DownloadDocumentListener listener, final Activity activity) {
