...
/**
 * Elemento de la l&iacute;nea de firma.
 */
public class SignLineElement {
	 ...
	 */
	public SignLineElement(final String signer) {
		this.signer = signer;
		this.done = false;
	}
	 ...
	 */
	public SignLineElement(final String signer, final boolean done) {
		this.signer = signer;
		this.done = done;
	}
