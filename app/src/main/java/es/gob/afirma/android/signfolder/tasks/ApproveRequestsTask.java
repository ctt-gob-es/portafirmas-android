...
public final class ApproveRequestsTask extends AsyncTask<Void, Void, RequestResult[]> {
	...
	public ApproveRequestsTask(final SignRequest[] requests, final CommManager commManager, final OperationRequestListener listener) {
	 ...
	 * @param commManager Manejador de las comunicaciones.
	 * @param listener Clase a notificar sobre las peticiones de aprobaci&oacute;n del usuario. */
	public ApproveRequestsTask(final String requestId, final CommManager commManager, final OperationRequestListener listener) {
